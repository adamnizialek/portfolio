      ...
      <div className="max-w-7xl mx-auto px-8 sm:px-10 md:px-12 lg:px-16 py-10 md:py-12 flex flex-col items-center justify-center gap-4 text-center">
        ...
        <div className="flex items-center gap-6">
          <a
            ...
            className="text-text-muted hover:text-neon-purple transition-colors duration-300"
            aria-label="GitHub"
          >
          ...
          <a
            ...
            className="text-text-muted hover:text-neon-pink transition-colors duration-300"
            aria-label="Email"
          >
            <svg
              className="w-5 h-5"
